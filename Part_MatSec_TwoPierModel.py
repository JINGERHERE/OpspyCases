...
"""
# ===== ===== ===== ===== ===== ===== ===== ===== ===== =====
@File    ：Part_MatSec_TwoPierModel.py
@Date    ：2025/8/1 19:17
@IDE     ：PyCharm
@Author  ：Wang Jing
...
"""
# --------------------------------------------------
# ========== < Part_MatSec_TwoPierModel > ==========
# --------------------------------------------------
"""


class TwoPierModelSection:
    ...
    def pier_sec(
        ...
        SEC.mesh()
        # 按点轮廓线添加钢筋
        rebars_outer = section.create_circle_points(xo_pier,
                                                    outer_radius - cover - dia_bar / 2,
                                                    angles=(0, 360), n_sub=n_bar)
        ...
        "# ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- -----"
        # 截面材料属性转换为字典
        # cover_dict = cover_params.to_dict()
        # core_dict = core_params.to_dict()
        # bar_dict = bar_params.to_dict()
